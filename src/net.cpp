...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Reaiscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"reaiscointools.com", "174.138.82.14"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"reaiscointools.com", "testnet-seed.reaiscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Reaiscoin is probably already running."), addrBind.ToString().c_str());
        else
